<?php include_once("lib/views/header.php"); ?>
<body>
<?php include_once("lib/views/new_nav.php"); ?>
...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
        <img src="image/249790.jpg" alt="img1" >
    ...
    <img src="image/266503.jpg" alt="img1" >
        <div class="carousel-caption d-none d-md-block">
            <h5>HI</h5>
            <p>All</p>
        </div>
    ...
    <div class="carousel-item">
    <img src="image/439635.jpg" alt="img1" >
        <div class="carousel-caption d-none d-md-block">
            <h5>HI</h5>
            <p>All</p>
        </div>
...
<div class="home-content">
  ...
  <div class="card">
    ...
    <div class="card-body">
      <h5 class="card-title">Faculty of Information Technology</h5>
      <a href="#"><button class="home-btn">More Infor</button></a>
    </div>
  </div>
  <div class="card">
  ...
  <div class="card">
    ...
    <div class="card-body">
      <h5 class="card-title">Faculty English</h5>
      <a href="#"><button class="home-btn">More Infor</button></a>
    </div>
  </div>
</div>
...
<?php include_once("lib/views/footer.php"); ?>
